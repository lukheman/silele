...
class NaiveBayes {
    ...
    public function __construct(int $jumlah_gejala) {
        $this->jumlah_gejala = $jumlah_gejala;
    }
     ...
     *
     */
    public function probabilitasGejalaBerdasarkanPenyakit(
        string $kode_penyakit,
        string $kode_gejala,
        float $probabilitas_penyakit,
        bool|int $gejala_is_exist
    ): float {
