<div>
    <section class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <!-- Gejala -->
        <x-card-stats variant="success" value="{{ $jumlahGejala }}">
            <x-slot:icon>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Basis Pengetahuan -->
        <x-card-stats variant="danger" value="{{ $jumlahBasisPengetahuan }}">
            <x-slot:icon>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Total Diagnosis -->
        <x-card-stats variant="warning" value="{{ $jumlahRiwayatDiagnosis }}">
            <x-slot:icon>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
